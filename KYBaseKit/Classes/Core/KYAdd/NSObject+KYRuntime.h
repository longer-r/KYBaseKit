 ...
 */
- (void)ky_setAssociateValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key    引用的指针，通过指针可以从 `self` 获取引用对象。
 */
- (void)ky_setAssociateWeakValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key 引用指针。
 */
- (nullable id)ky_getAssociatedValueForKey:(void *)key;
